...
export const satta_history_load = (date,user,params) => {
    return  async(dispatch) => {
        var row = Object.assign({},date,{id : user.id})
        var rdata = await AXIOS_REQUEST("satta/adminbethistory_email_load",{row,params})
        if(rdata.status){
