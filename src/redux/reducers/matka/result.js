...
import {MATKA_RESULT_GET_DATA,MATKA_RESULT_FILTER_DATA,MATKA_RESULT_BAZAARLIST_DATA,MATKA_RESULT_PAGENATION} from "../../types/matka"
  ...
  export const Result = (state = initialState, action) => {
    switch (action.type) {
      case MATKA_RESULT_GET_DATA:
        ...
        case MATKA_RESULT_BAZAARLIST_DATA : 
        return {
            ...state,bazaarlist : action.data
        }
        case MATKA_RESULT_PAGENATION:
        return {
          ...state,
          data: action.data,
          totalPages: action.totalPages,
