...
import {MATKA_GAMES_GET_DATA,MATKA_GAMES_FILTER_DATA,MATKA_GAMES_PAGENATION} from "../../types/matka"
...
const initialState = {
  ...
  export const gameslist = (state = initialState, action) => {
    switch (action.type) {
      case MATKA_GAMES_GET_DATA:
        return {
          ...state,
          data: action.data,
