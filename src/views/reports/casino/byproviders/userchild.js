...
import {  getData,getTotal} from "../../../../redux/actions/reports/casino/casinoproviders"
import {selectedStyle,pagenation_set} from "../../../../configs/providerconfig"
import Select from "react-select"
import Datepicker from "../../../lib/datepicker"

const FilterComponent = props =>{
  let provideroptions = props.dataList.toptbl && props.dataList.toptbl.provideroptions && props.dataList.toptbl.provideroptions.length > 0 ? props.dataList.toptbl.provideroptions : [];
  return (
      <Row>
        ...
        <Col md='3' sm='6' xs='12'>
          <FormGroup>
            ...
            <Select className="React" classNamePrefix="select" name="providerid" 
              ...
              value={provideroptions.find(obj => obj.value === props.filters.providerid)}
