...
import {  getData,getTotal} from "../../../../redux/actions/reports/casino/casinobet"
      ...
      columns: [
        {
          ...
          cell : row =>(
            <div className="textstyle">
            {row.gameid.PROVIDERID? row.gameid.PROVIDERID : ""}
          </div>
          )
        },
        {
          ...
          cell : row =>(
            <div className="textstyle">
            {row.gameid.TYPE? row.gameid.TYPE : ""}
          </div>
          )
        },
        {
        ...
        },
        {
          ...
          cell : row =>(
            <div className="textstyle">
            {row.gameid.NAME? row.gameid.NAME : ""}
          </div>
          )
        },
        {
...
const mapStateToProps = state => {
  return {
    dataList: state.Reports.reportscasinoplaygameid
  }
}
