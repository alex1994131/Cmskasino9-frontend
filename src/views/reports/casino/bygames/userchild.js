...
import {getData,getTotal} from "../../../../redux/actions/reports/casino/casinogameId"
...
const FilterComponent = props =>{
  ...
  return (
    <Row className="mb-1">
      ...
      <Col md='3' sm='6' xs='12'>
        <FormGroup>
          <Label for="user">Games</Label>
          <Select className="React" classNamePrefix="select" name="game" 
            options={gameoptions}
            value={gameoptions.find(obj => obj.value === props.filters.gameid)}
            onChange={e => props.handleFilter(e.value,"gameid")}
          />
        </FormGroup>
      </Col>
        {/* <Col md='3' sm='6' xs='12'>
        ...
        {/* <Col xs="6" md="3" className="mt-0">
          ...
          <Select 
            ...
            onChange={e => props.handleFilter(e.value,"providerss")}
            name="language" placeholder="Choose your Provider" 
          />
        </Col> */}
        {/* <Col xs="6" md="3" className="mt-2">
          <Select 
          options={props.me.types} 
          className="React"
          classNamePrefix="select"
          value={props.me.types ? props.me.filters.types : "" }
          onChange={(e)=>props.handleFilter(e,"types")}
...
const mapStateToProps = state => {
  return {
    dataList: state.Reports.reportscasinogameid
  }
}
