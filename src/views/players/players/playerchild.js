...
import {  getData,userDetailShow,  filterData,depositAction,withdrawalAction,pagenationChange,multiBlockAction,resetpass,getInactivePlayers} from "../../../redux/actions/Players/player/index"
...
import {Root,prefix} from "../../../authServices/rootconfig"
    ...
    amountaction(){
      if( this.state.type === "withdraw" && parseInt(this.state.amount) > this.state.selected.balance ){
        ...
        switch(this.state.type){
          ...
          break;
          case "withdraw":
            this.props.withdrawalAction({comment : this.state.commen,amount : parseInt(this.state.amount),email : this.state.selected.email,username : this.state.selected.username,amounttype : this.state.Amount_type},this.props.parsedFilter,this.state.filters);
          break;
          default:
            break;
        }
...
export default connect(mapStateToProps, {  getData, userDetailShow, filterData,depositAction,withdrawalAction,pagenationChange,multiBlockAction,resetpass,getInactivePlayers})(ListViewConfig)