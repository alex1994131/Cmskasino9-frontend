...
import {  getData,  filterData,deleteRow,pagenationchange} from "../../../redux/actions/user/realtimeusers/index"
...
class ListViewConfig extends Component {
    ...
    state = {
        ...
        date : [
          new Date(),
          new Date(new Date().valueOf() + 60 * 60 * 24 * 1000)
        ]
    }
...
const mapStateToProps = state => {
  return {
    dataList: state.userslist.realtimeusers
  }
}
