...
import {getData,filterData,menuupdate,pagenationchange} from "../../../redux/actions/CMS/sports/index"
...
class Child extends Component {
    ...
    rowEdit(row){
      this.me.setState({color : row.color,viewBox : row.viewBox,modal : true,sport_name : row.sport_name,icon : row.icon,sport_id : row.sport_id,rowid : row._id,update : true,ordernum : row.order,isChecked : row.status});
    }
