...
class Child extends Component {
    ...
    rowEdit(row){
      this.me.setState({mobileicon : row.mobileicon,modal : true,title : row.title,icon : row.icon,navLink : row.navLink,rowid : row._id,update : true,ordernum : row.order,isChecked : row.status});
    }
...
export default connect(mapStateToProps, {getData,filterData,menusave,menuupdate,menudelete})(Child)