...
const FpActionsComponent = props => {
  let action = props.props;
    return (
      <Row>
        <Button.Ripple className="round"   color="flat-success"onClick={() => {return action.firstpagecheck(props.row,true,action.parsedFilter,action.bool,props.state.filters)}}>
          <Check size={14} />Done
        </Button.Ripple>
...
class ListViewConfig extends Component {
    ...
    state = {
      ...
      columns: [ 
        ...
        //   maxWidth:  "50px",
        //   cell: params => {
        //     return params.fpstatus === true ? (
        //       <div className="badge badge-pill badge-light-success">
        //         Allow
        //       </div>
        //     ) : params.fpstatus === false ? (
        //       <div className="badge badge-pill badge-light-danger">
        //         Reject
        //       </div>
        //     ):null
