...
class DndHorizontal extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
       Sliders : [
         { bool : "5",type : "CMSFPMNGDATA1",value : "firstpagesliderimg1",title : "Firstpage slider 1"},
         { bool : "6",type : "CMSFPMNGDATA2",value : "firstpagesliderimg2",title : "Firstpage slider 2"},
         { bool : "7",type : "CMSFPMNGDATA3",value : "firstpagesliderimg3",title : "Firstpage slider 3"},
