...
class DndHorizontal extends React.Component {
  ...
  changeFile = (fpImg,editdata,gameid) => {
      if(fpImg){
      ...
      fpdata.append('text1', editdata.text1);
      fpdata.append('text2', editdata.text2);
      fpdata.append('text3', editdata.text3);
      fpdata.append('gameitem', gameid);
                                  ...
                                  <ListGroupItem>
                                    <Row>
                                      ...
                                      <Col style={{width:"100px"}}>
                                        <Row>
                                          <Col md="3">
                                            <div className="cursor-pointer"  onClick={() => this.EditChange(true,item)}>
                                              <Edit size={15} />
                                            </div>
                                          </Col>                          
                                          <Col md="3">
