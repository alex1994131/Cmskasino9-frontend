...
class App extends React.PureComponent {
   constructor(props) {
    ...
    this.state = {
      ...
      columns: [
        { dataField: 'title', text: 'title', width: window.innerWidth/6 },
        { dataField: 'icon', text: 'icon', width:  window.innerWidth/6 },
        { dataField: 'mobileicon', text: 'mobileicon', width:  window.innerWidth/6 },
        { dataField: 'navLink', text: 'navLink' ,  width: window.innerWidth/6},
        { dataField: 'type', text: 'type' , width:  window.innerWidth/6},
        { dataField: 'status', text: 'status' , width:  window.innerWidth/6},
  ...
  add_action = async ()=>{
    ...
    var row = { mobileicon : this.state.mobileicon, pid : pid,id :id,title: this.state.title,navLink : this.state.navLink,icon : this.state.icon,status : this.state.status,type : this.state.type}
    console.log(row);
  ...
  edit_action = async () =>{
    let id = this.state.selectitem.id;
    var row = {mobileicon : this.state.mobileicon,id :id,title: this.state.title,navLink : this.state.navLink,icon : this.state.icon,status : this.state.status,type : this.state.type}    
